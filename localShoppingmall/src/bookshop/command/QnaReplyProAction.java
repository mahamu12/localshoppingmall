...
public class QnaReplyProAction implements CommandAction {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response) throws Throwable {
		...
		request.setCharacterEncoding("UTF-8"); // utf-8 대문자로 변경
		// 상품 Qna 답변글 관련 내용
		...
		int qora = Integer.parseInt(request.getParameter("qora")); // Byte를 int 로 변경함 842p 25번째 줄
		int reply = 1; // 답변 여부 - 답변함 (byte를 int로 변경함)
